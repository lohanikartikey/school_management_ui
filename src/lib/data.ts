...
export const calendarEvents = [
  {
    ...
    end: new Date(2026, 0, 26, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 0, 26, 9, 0),
    end: new Date(2026, 0, 26, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 0, 26, 10, 0),
    end: new Date(2026, 0, 26, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 0, 26, 11, 0),
    end: new Date(2026, 0, 26, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 0, 26, 13, 0),
    end: new Date(2026, 0, 26, 13, 45),
  },
  {
    title: "History",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2026, 0, 27, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 0, 27, 10, 0),
    end: new Date(2026, 0, 27, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 0, 27, 11, 0),
    end: new Date(2026, 0, 27, 11, 45),
  },
  ...
  },
  {
    ...
    end: new Date(2026, 0, 28, 8, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 0, 28, 10, 0),
    end: new Date(2026, 0, 28, 10, 45),
  },
  ...
  },
  {
    ...
    end: new Date(2026, 0, 29, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 0, 29, 10, 0),
    end: new Date(2026, 0, 29, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 0, 29, 11, 0),
    end: new Date(2026, 0, 29, 11, 45),
  },
...

  {
    ...
    end: new Date(2026, 0, 30, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 0, 30, 13, 0),
    end: new Date(2026, 0, 30, 13, 45),
  },
  {
    title: "History",
    allDay: false,
