...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(2026, 0, 21, 8, 0),
    end: new Date(2026, 0, 21, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 0, 21, 9, 0),
    end: new Date(2026, 0, 21, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 0, 21, 10, 0),
    end: new Date(2026, 0, 21, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 0, 21, 11, 0),
    end: new Date(2026, 0, 21, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 0, 21, 13, 0),
    end: new Date(2026, 0, 21, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 0, 21, 14, 0),
    end: new Date(2026, 0, 21, 14, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 0, 22, 9, 0),
    end: new Date(2026, 0, 22, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 0, 22, 10, 0),
    end: new Date(2026, 0, 22, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 0, 22, 11, 0),
    end: new Date(2026, 0, 22, 11, 45),
  },

  {
    ...
    end: new Date(2026, 0, 22, 14, 45),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2026, 0, 23, 8, 0),
    end: new Date(2026, 0, 23, 8, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 0, 23, 10, 0),
    end: new Date(2026, 0, 23, 10, 45),
  },

  {
    ...
    end: new Date(2026, 0, 23, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 0, 23, 14, 0),
    end: new Date(2026, 0, 23, 14, 45),
  },
  {
    title: "English",
    allDay: false,
...

  {
    ...
    end: new Date(2026, 0, 19, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 0, 19, 13, 0),
    end: new Date(2026, 0, 19, 13, 45),
  },
  {
    title: "History",
    allDay: false,
