            ...
            <div className="w-full xl:w-2/3">
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                        ...
                        <div className="w-2/3 flex flex-col justify-between gap-4">
                            ...
                            <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
                                ...
                                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                                    ...
                                    <span className="">9274920764</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 flex gap-4 justify-between flex-wrap">
                        {/* CARD */}
                        <div className="bg-white w-full p-4 flex gap-4 items-center rounded-md md:w-[48%] lg:w-[45%] xl:[48%]">
            ...
            <div className="w-full xl:w-1/3 flex flex-col gap-4">
                <div className="bg-white p-4 rounded-md">
                    ...
                    <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                        <Link className="p-3 rounded-md bg-lamaPurpleLight" href="/">Student&apos;s Students</Link>
                        ...
                        <Link className="p-3 rounded-md bg-lamaPurpleLight" href="/">Student&apos;s Results</Link>
                    </div>
                </div>
